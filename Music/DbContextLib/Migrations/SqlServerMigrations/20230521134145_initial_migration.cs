        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    csMusicGroupMusicGroupId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Albums", x => x.AlbumId);
                    table.ForeignKey(
                        name: "FK_Albums_MusicGroups_csMusicGroupMusicGroupId",
                        column: x => x.csMusicGroupMusicGroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Artists_MusicGroups_csMusicGroupMusicGroupId",
                        column: x => x.csMusicGroupMusicGroupId,
                        principalTable: "MusicGroups",
                        principalColumn: "MusicGroupId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Albums_csMusicGroupMusicGroupId",
                table: "Albums",
                column: "csMusicGroupMusicGroupId");

            migrationBuilder.CreateIndex(
                name: "IX_Artists_csMusicGroupMusicGroupId",
                table: "Artists",
                column: "csMusicGroupMusicGroupId");
        }
